...
public class Start {
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            System.out.println("9 - Consultar Livro(código)");
            System.out.println("10 - Consultar Caderno(código)");
            System.out.println("11 - Consultar Pedido(código)");
            System.out.println("12 - Cadastrar Usuario");
            System.out.println("13 - Excluir Usuario");
            System.out.println("14 - Listar Usuario");
            ...
            switch (opcao) {
                ...
                case "9":
                    ...
                    String codLivro = LeitoraDados.lerDado();
                    produtoNegocio.consultar(codLivro);
                    break;
                case "10":
                    System.out.println("Digite o codigo do caderno");
                    String codCaderno = LeitoraDados.lerDado();
                    produtoNegocio.consultar(codCaderno);
                    break;
                case "11":
                    System.out.println("Digite o codigo do pedido");
                    String codPedido = LeitoraDados.lerDado();
                    produtoNegocio.consultar(codPedido);
                    break;
                case "12":
